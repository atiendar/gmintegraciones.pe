...
class StoreDireccionRequest extends FormRequest {
  ...
  public function rules() {
    return [
      'nombre_de_referencia_uno'    => 'required|max:65500|string',
      'nombre_de_referencia_dos'    => 'nullable|max:65500|string',
      ...
      'referencias_zona_de_entrega' => 'nullable|max:65500|string',
    ];
  }
}