...
<div class="card">
  ...
  <div class="card-body">
    <div class="pb-1">
      ...
      <div style="float: right;">
        <div class="input-group input-group-sm" style="width: 25em;">
          {!! Form::select('opcion_buscador', config('opcionesSelect.select_rol_index'), null, ['class' => 'form-control float-right']) !!}
    ...
    <div class="pt-2">
      ...
      {{ __('Mostrando desde') . ' '. $roles->firstItem() . ' ' . __('hasta') . ' '. $roles->lastItem() . ' ' . __('de') . ' '. $roles->total() . ' ' . __('registros') }}.
    </div>
  </div>
</div>
@endsection