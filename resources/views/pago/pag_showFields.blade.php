  ...
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      <div class="input-group-prepend">
        ...
        {!! Form::text('updated_at', $pago->updated_at, ['class' => 'form-control disabled', 'maxlength' => 0, 'placeholder' => __('Ultima modificación'), 'readonly' => 'readonly']) !!}
    </div>
  </div>
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::text('updated_at_us', $pago->updated_at_pag, ['class' => 'form-control disabled', 'maxlength' => 0, 'placeholder' => __('Ultima modificación por'), 'readonly' => 'readonly']) !!}
    </div>
  </div>
</div>
<div class="row">
