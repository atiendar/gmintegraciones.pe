      ...
      <tbody> 
        @foreach($direcciones as $direccion)
          <tr title="{{ $direccion->cant }}">
            ...
            @include('cotizacion.armado_cotizacion.direccion_armado.cot_arm_dir_table.td.cantidad', ['show' => true, 'canany' => ['produccion.pedidoActivo.armado.show', 'produccion.pedidoActivo.show'], 'ruta' => 'produccion.pedidoActivo.armado.direccion.show', 'target' => null])
