    ...
    <div class="pb-1">
      ...
      <div style="float: right;">
        <div class="input-group input-group-sm" style="width: 25em;">
          ...
          <div class="input-group-append">
            <a href="{{ route(Request::is('armado/clon/editar/*') ? 'armado.clon.edit' : 'armado.clon.show', Crypt::encrypt($armado->id)) }}" class="btn btn-default" title="{{ __('Mostrar todos los registros') }}"><i class="fas fa-spinner"></i></a>
          </div>
        </div>
      </div>
