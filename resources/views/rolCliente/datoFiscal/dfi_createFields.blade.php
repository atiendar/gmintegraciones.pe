<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      <div class="input-group-prepend">
        ...
        {!! Form::text('nombre_o_razon_social', null, ['class' => 'form-control' . ($errors->has('nombre_o_razon_social') ? ' is-invalid' : ''), 'maxlength' => 60, 'placeholder' => __('Nombre o razón social')]) !!}
    </div>
  ...
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::text('rfc', null, ['class' => 'form-control' . ($errors->has('rfc') ? ' is-invalid' : ''), 'maxlength' => 20, 'placeholder' => __('RFC')]) !!}
    </div>
