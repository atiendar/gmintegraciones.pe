...
@section('contenido')
<title>@section('title', __('Lista de direcciones foraneas'))</title>
<div class="card">
  ...
  <div class="card-body">
    {!! Form::model(Request::all(), ['route' => 'logistica.direccionForaneo.index', 'method' => 'GET']) !!}
      @include('global.buscador.buscador', ['ruta_recarga' => route('logistica.direccionForaneo.index'), 'opciones_buscador' => config('opcionesSelect.select_logistica_direcciones_index')])
    {!! Form::close() !!}
