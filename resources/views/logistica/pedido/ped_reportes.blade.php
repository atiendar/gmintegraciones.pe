@if(Request::route()->getName() == 'logistica.pedidoActivo.index')
  @canany(['logistica.pedidoActivo.index'])
    <li class="nav-item ml-auto">
      {!! Form::open(['route' => 'logistica.pedidoActivo.generarReporte', 'method' => 'get', 'onsubmit' => 'return checarBotonSubmit("btnsubmitgen1")']) !!}
...
@if(Request::route()->getName() == 'logistica.direccionLocal.index')
  @canany(['logistica.direccionLocal.index'])
    <li class="nav-item ml-auto">
      {!! Form::open(['route' => 'logistica.direccionLocal.generarReporte', 'method' => 'get', 'onsubmit' => 'return checarBotonSubmit("btnsubmitgen2")']) !!}
...
@if(Request::route()->getName() == 'logistica.direccionForaneo.index')
  @canany(['logistica.direccionForaneo.index'])
    <li class="nav-item ml-auto">
      {!! Form::open(['route' => 'logistica.direccionForaneo.generarReporte', 'method' => 'get', 'onsubmit' => 'return checarBotonSubmit("btnsubmitgen3")']) !!}
