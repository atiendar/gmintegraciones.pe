<div class="row">
  ...
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::select('cuenta_con_seguro', config('opcionesSelect.select_si_no'), null, ['class' => 'form-control select2' . ($errors->has('cuenta_con_seguro') ? ' is-invalid' : ''), 'placeholder' => __('')]) !!}
    </div>
