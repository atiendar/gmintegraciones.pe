    ...
    <div class="form-group col-sm btn-sm">
    <label for="ultimo_mantenimiento">{{ __('Ultimo mantenimiento')}}</label>
      <div class="input-group">
        <div class="input-group-prepend">
        <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
        </div>
        {!! Form::text('ultimo_mantenimiento', $inventario->ult_fec_de_man, ['class' => 'form-control disabled', 'maxlength' => 40, 'placeholder' => __('Ultimo mantenimiento'), 'readonly' => 'readonly']) !!}
      </div>
     </div>
    </div>
    <div class="row">
