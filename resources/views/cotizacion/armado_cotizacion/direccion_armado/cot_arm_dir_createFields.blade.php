  ...
  <div class="row">
    ...
    <div class="form-group col-sm btn-sm">
      ...
      <div class="input-group">
        ...
        {!! Form::text('estado_al_que_se_cotizo', null, ['v-model' => 'estado_al_que_se_cotizo', 'class' => 'form-control form-control-sm disabled', 'maxlength' => 0, 'placeholder' => __('Estado al que se cotizo'), 'readonly' => 'readonly']) !!}  
      </div>
    </div>
    <div class="form-group col-sm btn-sm">
