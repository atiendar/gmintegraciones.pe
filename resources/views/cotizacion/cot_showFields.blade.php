<div class="row">
  ...
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::text('created_at_us', $cotizacion->created_at_cot, ['class' => 'form-control disabled', 'maxlength' => 0, 'placeholder' => __('Registrado por'), 'readonly' => 'readonly']) !!}
    </div>
  </div>
</div>
...
<div class="row">
  ...
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::text('updated_at_us', $cotizacion->updated_at_cot, ['class' => 'form-control disabled', 'maxlength' => 0, 'placeholder' => __('Ultima modificación por'), 'readonly' => 'readonly']) !!}
    </div>
  </div>
</div>
