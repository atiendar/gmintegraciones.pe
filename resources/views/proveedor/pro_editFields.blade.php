...
<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::textarea('observaciones', $proveedor->obs, ['class' => 'form-control' . ($errors->has('observaciones') ? ' is-invalid' : ''), 'maxlength' => 65500, 'placeholder' => __('Observaciones'), 'rows' => 4, 'cols' => 4]) !!}
    </div>
  ...
  <div class="row">
    <div class="form-group col-sm btn-sm">
      ...
      <div class="input-group">
        ...
        {!! Form::text('pais', $proveedor->pais, ['class' => 'form-control' . ($errors->has('pais') ? ' is-invalid' : ''), 'maxlength' => 40, 'placeholder' => __('Pais')]) !!}
      </div>
  ...
  <div class="row">
    <div class="form-group col-sm btn-sm">
      ...
      <div class="input-group">
        ...
        {!! Form::textarea('referencias', $proveedor->ref, ['class' => 'form-control' . ($errors->has('referencias') ? ' is-invalid' : ''), 'maxlength' => 65500, 'placeholder' => __('Referencias'), 'rows' => 4, 'cols' => 4]) !!}
      </div>
