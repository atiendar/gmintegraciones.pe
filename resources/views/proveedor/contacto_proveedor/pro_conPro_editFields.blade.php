...
<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::textarea('observaciones', $contacto->obs, ['class' => 'form-control' . ($errors->has('observaciones') ? ' is-invalid' : ''), 'maxlength' => 65500, 'placeholder' => __('Observaciones'), 'rows' => 4, 'cols' => 4]) !!}
    </div>
