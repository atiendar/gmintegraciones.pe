<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      <div class="input-group-prepend">
        ...
        {!! Form::text('nombre', null, ['class' => 'form-control' . ($errors->has('nombre') ? ' is-invalid' : ''), 'maxlength' => 80, 'placeholder' => __('Nombre')]) !!}
    </div>
  ...
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::text('cargo', null, ['class' => 'form-control' . ($errors->has('cargo') ? ' is-invalid' : ''), 'maxlength' => 100, 'placeholder' => __('Cargo')]) !!}
    </div>
...
<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::text('correo', null, ['class' => 'form-control' . ($errors->has('correo') ? ' is-invalid' : ''), 'maxlength' => 75, 'placeholder' => __('Correo')]) !!}
    </div>
...
<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::textarea('observaciones', null, ['class' => 'form-control' . ($errors->has('observaciones') ? ' is-invalid' : ''), 'maxlength' => 65500, 'placeholder' => __('Observaciones'), 'rows' => 4, 'cols' => 4]) !!}
    </div>
...
<div class="row">
  <div class="form-group col-sm btn-sm">
    <a href="{{ route('proveedor.edit', Crypt::encrypt($proveedor->id)) }}" class="btn btn-default w-50 p-2 border"><i class="fas fa-sign-out-alt text-dark"></i> {{ __('Continuar con el proveedor') }}</a>
  </div>
  <div class="form-group col-sm btn-sm">
