@include('venta.pedido_activo.armado_pedidoActivo.ven_pedAct_armPedAct_showFields.imagenArmado')
...
<div class="row">
  ...
  @include('venta.pedido_activo.armado_pedidoActivo.ven_pedAct_armPedAct_showFields.autorizado')
</div>
<div class="row">
...
<div class="row">
  <div class="col-md-7">
    <div class="pad">
      ...
      <div class="row">
        @include('venta.pedido_activo.armado_pedidoActivo.ven_pedAct_armPedAct_showFields.ubicacionRack')
...
<div class="row">
  @include('venta.pedido_activo.armado_pedidoActivo.ven_pedAct_armPedAct_showFields.comentariosLogistica')
</div>
<div class="row">
  <div class="form-group col-sm btn-sm">
    <center><a href="{{ route('venta.pedidoActivo.edit', Crypt::encrypt($armado->pedido->id)) }}" class="btn btn-default w-50 p-2 border"><i class="fas fa-sign-out-alt text-dark"></i> {{ __('Continuar con el pedido') }}</a></center>
  </div>
</div>
...
@include('venta.pedido_activo.armado_pedidoActivo.ven_pedAct_armPedAct_showFields.comprobanteDeSalida')
<div class="row">
  @include('venta.pedido_activo.armado_pedidoActivo.ven_pedAct_armPedAct_showFields.created')
</div>
<div class="row">
...
<div class="row">
  @include('venta.pedido_activo.armado_pedidoActivo.ven_pedAct_armPedAct_showFields.precio')
</div>
@include('venta.pedido_activo.armado_pedidoActivo.ven_pedAct_armPedAct_showFields.productosArmado')
<div class="row">
  @include('venta.pedido_activo.armado_pedidoActivo.ven_pedAct_armPedAct_showFields.regalo')
