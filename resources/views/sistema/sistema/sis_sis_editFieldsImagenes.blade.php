...
<div class="border border-primary rounded p-2">
  <div class="row">
    <div class="form-group col-sm btn-sm">
      <label for="logo_color_negro">{{ __('Logo color negro') }} (583 x 239px)</label>
    ...
    <div class="form-group col-sm btn-sm">
      <label for="logo_color_blanco">{{ __('Logo color blanco') }} (583 x 239px)</label>
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
        </div>
  ...
  <div class="row">
    <div class="form-group col-sm btn-sm">
      <label for="imagen_login">{{ __('Imagen login') }} (1200 x 800px)</label>
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
        </div>
    ...
    <div class="form-group col-sm btn-sm">
      <label for="imagen_restablecer_la_contraseña">{{ __('Imagen restablecer la contraseña') }} (1200 x 800px)</label>
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
        </div>
  ...
  <div class="row">
    <div class="form-group col-sm btn-sm">
      <label for="imagen_nueva_contraseña">{{ __('Imagen nueva contraseña') }} (1200 x 800px)</label>
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
        </div>
    ...
    <div class="form-group col-sm btn-sm">
      <label for="imagen_predeterminada_del_perfil">{{ __('Imagen predeterminada del perfil') }} (300 x 300px)</label>
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
        </div>
  ...
  <div class="row">
    <div class="form-group col-sm btn-sm">
      <label for="imagen_modulo_en_desarrollo">{{ __('Imagen módulo en desarrollo') }} (860 x 563px)</label>
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
        </div>
    ...
    <div class="form-group col-sm btn-sm">
      <label for="imagen_error">{{ __('Imagen error') }} (960 x 752px)</label>
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
        </div>
