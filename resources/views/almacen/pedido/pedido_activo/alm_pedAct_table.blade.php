      ...
      @else 
        <thead>
          <tr> 
            ...
            @include('venta.pedido_activo.ven_pedAct_table.th.estatusAlmacen')
            @include('venta.pedido_activo.ven_pedAct_table.th.cliente')
            @include('venta.pedido_activo.ven_pedAct_table.th.totalDeArmados')
        ...
        <tbody> 
          @foreach($pedidos as $pedido)
            <tr title="{{ $pedido->serie.$pedido->id }}">
              @include('almacen.pedido_activo.alm_pedAct_tableOpcionShow')
              ...
              @include('venta.pedido_activo.ven_pedAct_table.td.estatusAlmacen')
              @include('venta.pedido_activo.ven_pedAct_table.td.cliente')
              @include('venta.pedido_activo.ven_pedAct_table.td.totalDeArmados')
              @if(Request::route()->getName() == 'almacen.pedidoActivo.index')
              @include('almacen.pedido_activo.alm_pedAct_tableOpciones')
              @else
              <td></td>
             @endif
            </tr>
