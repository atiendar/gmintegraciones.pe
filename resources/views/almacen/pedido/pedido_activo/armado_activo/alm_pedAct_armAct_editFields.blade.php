...
<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::textarea('comentario_almacen', $armado->coment_alm, ['class' => 'form-control' . ($errors->has('comentario_almacen') ? ' is-invalid' : ''), 'maxlength' => 65500, 'placeholder' => __('Comentario almacén'), 'rows' => 4, 'cols' => 4]) !!}
    </div>
...
<div class="row">
  <div class="form-group col-sm btn-sm" >
    <a href="{{ route('almacen.pedidoActivo.edit', Crypt::encrypt($armado->pedido->id)) }}" class="btn btn-default w-50 p-2 border"><i class="fas fa-sign-out-alt text-dark"></i> {{ __('Continuar con el pedido') }}</a>
  </div>
  <div class="form-group col-sm btn-sm">
