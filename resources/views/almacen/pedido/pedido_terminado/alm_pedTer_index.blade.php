...
<div class="card">
  ...
  <div class="card-body">
    {!! Form::model(Request::all(), ['route' => 'almacen.pedidoTerminado.index', 'method' => 'GET']) !!}
      @include('global.buscador.buscador', ['ruta_recarga' => route('almacen.pedidoTerminado.index'), 'opciones_buscador' => config('opcionesSelect.select_almacen_pedido_activo_index')])
    {!! Form::close() !!}
