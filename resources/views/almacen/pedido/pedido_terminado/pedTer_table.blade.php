      ...
      <tbody> 
        @foreach($pedidos as $pedido)
          <tr title="{{ $pedido->num_pedido }}">
            @include('venta.pedido.pedido_activo.ven_pedAct_table.td.opcionShow', ['canany' => ['almacen.pedidoTerminado.show'], 'ruta' => route('almacen.pedidoTerminado.show', Crypt::encrypt($pedido->id))])
