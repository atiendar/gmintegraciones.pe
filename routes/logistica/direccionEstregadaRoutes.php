...
Route::group(['prefix' => 'direccion-entregada'], function() {
  ...
  Route::match(['GET', 'HEAD'],'regresar-en-ruta/{id_direccion}', 'Logistica\DireccionEntregada\DireccionEntregadaController@regresarEnRuta')->name('logistica.direccionEntregada.regresarEnRuta')->middleware('permission:logistica.direccionForaneo.edit|logistica.direccionLocal.edit');
});