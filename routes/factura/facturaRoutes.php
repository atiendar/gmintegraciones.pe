...
Route::group(['prefix' => 'factura'], function() {
  ...
  Route::match(['GET', 'HEAD'],'obtener-informacion-dato-fiscal/{id_dato_fiscal}', 'RolCliente\DatoFiscal\DatoFiscalController@getInformacionDatoFiscal')->name('factura.getInformacionDatoFiscal')->middleware('permission:factura.create');
});