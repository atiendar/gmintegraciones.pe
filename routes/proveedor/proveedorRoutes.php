...
Route::group(['prefix' => 'proveedor'], function() {
  ...
  Route::match(['GET', 'HEAD'],'editar/{id_proveedor}', 'Proveedor\ProveedorController@edit')->name('proveedor.edit')->middleware('permission:proveedor.edit|proveedor.contacto.index|proveedor.contacto.create|proveedor.contacto.edit|proveedor.contacto.destroy');
