...
Route::group(['prefix' => 'proveedor'], function() {
  Route::match(['GET', 'HEAD'],'', 'Proveedor\ProveedorController@index')->name('proveedor.index')->middleware('permission:proveedor.index|proveedor.create|proveedor.show|proveedor.edit|proveedor.destroy|proveedor.contacto.index|proveedor.contacto.create|proveedor.contacto.show|proveedor.contacto.edit|proveedor.contacto.destroy');
  ...
  Route::match(['GET', 'HEAD'],'detalles/{id_proveedor}', 'Proveedor\ProveedorController@show')->name('proveedor.show')->middleware('permission:proveedor.show');
  Route::match(['GET', 'HEAD'],'editar/{id_proveedor}', 'Proveedor\ProveedorController@edit')->name('proveedor.edit')->middleware('permission:proveedor.edit|proveedor.contacto.index|proveedor.contacto.create|proveedor.contacto.show|proveedor.contacto.edit|proveedor.contacto.destroy');
  ...
  Route::group(['prefix' => 'contacto'], function() {
    ...
    Route::match(['GET', 'HEAD'],'detalles/{id_contacto}', 'Proveedor\ContactoProveedor\ContactoController@show')->name('proveedor.contacto.show')->middleware('permission:proveedor.contacto.show');
