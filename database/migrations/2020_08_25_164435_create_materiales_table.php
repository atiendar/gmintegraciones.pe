...
class CreateMaterialesTable extends Migration {
    ...
    public function up() {
      Schema::create('materiales', function (Blueprint $table) {
        ...
        $table->string('sku',150)->nullable()->comment('SKU');
        $table->text('des')->nullable()->comment('Descripción');
        $table->string('lob',150)->nullable()->comment('Lob');
        $table->string('produc_lin',150)->nullable()->comment('Product Line');
        $table->string('produc_lin_sub_gro',150)->nullable()->comment('Product Line Sub-Group');
        $table->string('fam_de_prod',150)->nullable()->comment('Familia de producto');
        $table->string('lin_de_prod',150)->nullable()->comment('Linea de producto');
        $table->string('sub_lin_de_prod',150)->nullable()->comment('Sub Linea de producto');
