...
class CreateSistemaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sistema', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('plant_usu')->nullable()->comment('Id de la plantilla por default para el módulo Usuarios (Bienvenida)');
            $table->unsignedBigInteger('plant_cli')->nullable()->comment('Id de la plantilla por default para el módulo Clientes (Bienvenida)');
            ...
            $table->unsignedBigInteger('plant_sis_rest_pass')->nullable()->comment('Id de la plantilla por default para el restablecimiento de contraseña');
            $table->unsignedBigInteger('plant_cot')->nullable()->comment('Id de la plantilla por default para el módulo Cotizaciones (Enviar cotización)');
            $table->unsignedBigInteger('plant_vent')->nullable()->comment('Id de la plantilla por default para el módulo Ventas (Registrar pedido)');
